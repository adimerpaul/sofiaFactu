<template>
  <div style="height: 350px; width: 100%;">
    ...
    <div class="row">
      <div class="col-12">
        <q-table :rows="clientes" hide-header :filter="filter" :columns="columns" :rows-per-page-options="[0]"
                 class="my-sticky-header-table">
          <template v-slot:body-cell-Cod_Aut="props">
            <q-td
              :class="props.row.tipo=='PEDIDO'?'bg-green-3  text-italic':props.row.tipo=='PARADO'?'bg-yellow-3  text-italic':props.row.tipo=='NO PEDIDO'?'bg-red-3 text-italic':''"
              @click="clickopciones(props.row)" :props="props">
      ...
      <q-card>
        ...
        <q-card-section class="q-pt-none">
          <div class="row">
            ...
            <div class="col-6">
              <q-input type="number" dense outlined label="Cja-104(1.5-1.7)" v-model="miproducto.c104"/>
            </div>
            <div class="col-6">
            ...
            <div class="col-6">
              <q-input type="number" dense outlined label="Cja-105(1.7-1.9)" v-model="miproducto.c105"/>
            </div>
            <div class="col-6">
            ...
            <div class="col-6">
              <q-input type="number" dense outlined label="Cja-106(1.9-2.2)" v-model="miproducto.c106"/>
            </div>
            <div class="col-6">
            ...
            <div class="col-6">
              <q-input type="number" dense outlined label="Cja-107(2.2-2.5)" v-model="miproducto.c107"/>
            </div>
            <div class="col-6">
            ...
            <div class="col-6">
              <q-input type="number" dense outlined label="Cja-108(2.6-2.7)" v-model="miproducto.c108"/>
            </div>
            <div class="col-6">
            ...
            <div class="col-6">
              <q-input type="number" dense outlined label="Cja-109(2.8-2.9)" v-model="miproducto.c109"/>
            </div>
            <div class="col-6">
            ...
            <div class="col-6">
              <q-input type="number" dense outlined label="Rango Pollo (unidades)" v-model="miproducto.rango"/>
            </div>
            <div class="col-6"></div>
            ...
            <div class="col-6">
              <q-input type="number" dense outlined label="pi/mu" v-model="miproducto.pie"/>
            </div>
            <div class="col-6">
            ...
            <div class="col-6">
              <q-input type="number" dense outlined label="menudencia" v-model="miproducto.menu"/>
            </div>
            <div class="col-6">
